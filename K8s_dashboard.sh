#!/bin/bash
if [[ "$1" == 'install' ]]; then 
    kubectl apply -f https://raw.githubusercontent.com/Preethamym3/My_Automation/main/k8s_dashboard.yml
...
EOF
    ...
    kubectl delete -f https://raw.githubusercontent.com/Preethamym3/My_Automation/main/k8s_dashboard.yml
